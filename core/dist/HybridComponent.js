...
import { useRef } from 'react'; // In order to subclass this class, you import the
...
export class HybridComponent {
  ...
  hooks() {// Override this method with all your hook invocations
  ...
  static functionalize() {
    let functional_component = this._render.bind(this); // React expects the defaultProps to be a property of the exported
