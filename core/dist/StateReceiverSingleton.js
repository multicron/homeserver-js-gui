...
import StateHolder from '@homeserver-js-gui/core/StateHolder';
...
export class StateReceiverSingleton extends StateHolder {
  ...
  receive_dispatch(message) {
    let action = JSON.parse(message); // Add this offset to times on the client to get time on the server
