...
exports.default = exports.IconSwitch = void 0;
...
var IconSwitch = /*#__PURE__*/function (_ToggleSwitch) {
  _inherits(IconSwitch, _ToggleSwitch);

  var _super = _createSuper(IconSwitch);

  function IconSwitch() {
    var _this;

    _classCallCheck(this, IconSwitch);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChange", function (event, value) {
      ...
      _this.send_mqtt_msg(command, value ? _this.props.true_value : _this.props.false_value);
    });

    return _this;
  }

  _createClass(IconSwitch, [{
    key: "render",
    value: function render() {
      ...
      }, "ON")), /*#__PURE__*/_react.default.createElement(_Grid.default, {
        item: true
      }, /*#__PURE__*/_react.default.createElement(_Button.default, {
        variant: this.props.variant,
        size: this.props.size,
  ...
  return IconSwitch;
}(_widget.ToggleSwitch);

exports.IconSwitch = IconSwitch;

_defineProperty(IconSwitch, "defaultProps", _objectSpread(_objectSpread({}, _get(_getPrototypeOf(IconSwitch), "defaultProps", IconSwitch)), {}, {
  size: "small",
  variant: "outlined"
}));

var _default = IconSwitch.functionalize();
